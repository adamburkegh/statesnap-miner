...
EXPOSITOR_IN_WAITING='侍講'
ACADEMICIAN_EXPOSITOR_IN_WAITING='侍講'+ACADEMICIAN
HANLIN_ACAD_EIW=HANLIN + EXPOSITOR_IN_WAITING + ACADEMICIAN
...
COUNTY_VICE_MAGISTRATE = '縣丞'
COUNTY_PREFECT = '知府'
countyroles = [COUNTY_MAGISTRATE,COUNTY_PREFECT,COUNTY_VICE_MAGISTRATE]

DEPARTMENT_MAGISTRATE = '知州'
DEPARTMENT_VICE_MAGISTRATE = '州同'
DEPARTMENT_ASSISTANT_MAGISTRATE = '州判'
magistrates = [DEPARTMENT_MAGISTRATE,DEPARTMENT_ASSISTANT_MAGISTRATE,DEPARTMENT_VICE_MAGISTRATE]
...
PALACE_SCHOOL = '咸安宫' # Palace of Universal Peace
