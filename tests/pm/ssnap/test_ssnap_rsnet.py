...
class StateSnapshotMinerRoleStateNetTest(unittest.TestCase):
    ...
    def test_one_case_two_seq_states(self):
        sslog = {1: [ StateSnapshot(1,1700,
                      ...
                      StateSnapshot(1,1701,
                           set(['Student']) ) ] } 
        expected = self.net(
            "I -> [tau__1] -> Sweep -> [tau__2] -> Student -> [tau__3] -> F")
        self.add(expected,   "Sweep -> {tau__4 0.8} -> F")
    ...
    def test_add_concurrent_role(self):
        ...
        self.add(expected,  "Student -> {tau__3 0.8} -> F")
        self.add(expected,  "Student -> [tau__4] -> F")
    ...
    def test_lose_concurrent_role(self):
        ...
        self.add(expected,  "Student -> [tau__4] -> F")
        self.add(expected,  "Student -> {tau__5 0.8} -> F")
        self.add(expected,    "Sweep -> {tau__5 0.8} -> F")
        sslog = {1: [ StateSnapshot(1,1700,
                                    set(['Student'])) ,
                      StateSnapshot(1,1701,
                                    set(['Student','Sweep']) ),
    ...
    def test_two_conc_one_choice_one(self):
        ...
        self.add(expected,    "Drone -> {tau__7 0.8} -> F")
        self.add(expected,  "Student -> {tau__8 0.8} -> F")
        #
        self.add(expected,  "Bludger -> {tau__9 0.8} -> F")
        self.add(expected,    "Sweep -> {tau__9 0.8} -> F")
        self.add(expected,  "Student -> [tau__10] -> F")
        self.add(expected,    "Sweep -> [tau__10] -> F")
        self.add(expected,  "Student -> {tau__11 0.8} -> F")
        self.add(expected,    "Tutor -> {tau__11 0.8} -> F")
        self.add(expected,    "Drone -> {tau__12 0.8} -> F")
        self.add(expected,    "Sweep -> {tau__12 0.8} -> F")
        self.add(expected,  "Bludger -> [tau__13] -> F")
        self.add(expected,    "Tutor -> [tau__13] -> F")
        #
        self.add(expected,  "Bludger -> {tau__14 0.8} -> F")
        self.add(expected,    "Sweep -> {tau__14 0.8} -> F")
        self.add(expected,    "Tutor -> {tau__14 0.8} -> F")
        self.add(expected,  "Student -> {tau__15 0.8} -> F")
        self.add(expected,    "Sweep -> {tau__15 0.8} -> F")
        self.add(expected,    "Tutor -> {tau__15 0.8} -> F")
        #
        sslog = {1: [ StateSnapshot(1,1700,
                                    set(['Student'])) ,
                      StateSnapshot(1,1701,
